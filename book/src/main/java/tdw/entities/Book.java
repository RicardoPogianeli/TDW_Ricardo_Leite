...
@NamedQueries({
    ...
    @NamedQuery(name = "Book.findByPrince", query = "SELECT b FROM Book b WHERE b.prince = :prince")})
public class Book implements Serializable {
    ...
    public Book(Integer id, String name, String author, String category, int year, float prince) {
        this.id = id;
        this.name = name;
        this.author = author;
